...
public class TaskController {
    ...
    @Autowired
    public TaskController(TaskService taskService, UserService userService, CategoryService categoryService, TaskRepository taskRepository) {
    ...
    public String createTask(@RequestParam String title, @RequestParam String description, @RequestParam String priority, @RequestParam String due_date, @RequestParam(name = "selectedCategories") List<Long> selectedCategoriesIDs) {
        ...
        task.setDueDate(LocalDateTime.parse(due_date, DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm")));
